...
for test in PsrdNoiseTest CpuChunkSeamTest CpuEmptyChunkTest ChunkBufferPoolTest ChunkGenerationKeyTest ShaderFaceTest StormCoverageTest StormFogMapTest; do
  echo "RUN $test"
