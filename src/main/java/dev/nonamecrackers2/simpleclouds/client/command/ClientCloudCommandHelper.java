...
public class ClientCloudCommandHelper
{
	...
	public static final CloudCommandSource<ClientLevel, ClientCloudManager> SOURCE = new CloudCommandSource<>()
	{
		...
		@Override
		public <C> ClientCloudManager getCloudManager(CommandContext<C> context) throws CommandSyntaxException
		{
		...
		@Override
		public <C> int setCloudHeight(CommandContext<C> context) throws CommandSyntaxException 
		{
			throw CONFIG_REFERAL.create();
		}
		
		@Override
		public <C> int setSpeed(CommandContext<C> context) throws CommandSyntaxException 
		{
			throw CONFIG_REFERAL.create();
		}
	};
