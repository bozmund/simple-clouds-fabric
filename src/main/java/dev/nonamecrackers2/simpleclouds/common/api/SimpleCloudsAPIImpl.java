...
public class SimpleCloudsAPIImpl implements SimpleCloudsAPI
{
	...
	@Override
	public ScAPICloudRegion createCloudRegion(Identifier cloudTypeId, Vec2 movementDirection, float maxSpeed, float accelerationFactor, float posX, float posZ, float radius, float rotation, float stretchFactor, int existsForTicks, int growTicks, int orderWeight)
	{
