...
public record CloudType(Identifier id, WeatherType weatherType, float storminess, float stormStart, float stormFadeDistance, float transparencyFade, NoiseSettings noiseConfig) implements CloudInfo, ScAPICloudType
{
	...
	public static CloudType readFromJson(Identifier id, JsonObject object) throws JsonSyntaxException
	{
