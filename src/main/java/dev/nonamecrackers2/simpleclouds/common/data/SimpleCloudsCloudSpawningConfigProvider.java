...
{
	private static final BiasedToBottomInt SPAWN_INTERVAL = BiasedToBottomInt.of(2400, 12000);
	...
	public CompletableFuture<?> run(CachedOutput output)
	{
		...
		JsonObject spawnInterval = new JsonObject();
		spawnInterval.addProperty("type", "biased_to_bottom");
		spawnInterval.addProperty("min", 2400);
		spawnInterval.addProperty("max", 12000);
		root.add("spawn_interval", spawnInterval);
