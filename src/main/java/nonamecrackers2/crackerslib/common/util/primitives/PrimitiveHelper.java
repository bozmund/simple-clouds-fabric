...
public class PrimitiveHelper
{
	...
	public static Quaternionf quaternionFromTag(CompoundTag tag)
	{
		...
		if (tag.contains("x"))
			quaternion.x = tag.getFloatOr("x", 0f);
		if (tag.contains("y"))
			quaternion.y = tag.getFloatOr("y", 0f);
		if (tag.contains("z"))
			quaternion.z = tag.getFloatOr("z", 0f);
		if (tag.contains("w"))
			quaternion.w = tag.getFloatOr("w", 0f);
		return quaternion;
	}
	...
	{
		return new Vector3f(tag.getFloatOr("x", 0f), tag.getFloatOr("y", 0f), tag.getFloatOr("z", 0f));
	}
	...
	{
		return new Vec3(tag.getDoubleOr("x", 0d), tag.getDoubleOr("y", 0d), tag.getDoubleOr("z", 0d));
	}
	...
	{
		return new Vec2(tag.getFloatOr("x", 0f), tag.getFloatOr("y", 0f));
	}
